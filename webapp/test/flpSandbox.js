		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Extintores",
									"targetURL": "#projectparte2project1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectparte2project1-display": {
								"semanticObject": "projectparte2project1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectparte2.project1",
									"url": sap.ui.require.toUrl("projectparte2/project1")
								}
							}
						}
					}
